...
class UserRegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            "password",
            HTML(
                f'<p>Already have an account ? <a style="color: blue;" href="{login_page_url}">SignIn</a></p>'
            ),
...
class UserLoginForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            "password",
            HTML(
                f'<p>Create new account ? <a style="color: blue;" href="{registration_page_url}">SignUp</a></p>'
            ),
...
class InviteSentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div("receiver_email", "event_id", css_class="modal-body"),
            Div(
                HTML(
