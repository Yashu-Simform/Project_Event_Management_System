...
urlpatterns = [
    ...
    path(
        "user/dashboard/myevents/",
        MyEventsView.as_view(),
        name="user_dashboard_myevents_page",
    ),
    path(
        "user/dashboard/invitations/",
        InvitationsView.as_view(),
        name="user_dashboard_invitations_page",
    ),
    path("event/<int:event_id>/retrive/", EventDetail.as_view(), name="event_details"),
    path(
        "event/<int:event_id>/update/", EventUpdateView.as_view(), name="event_update"
    ),
